...
public abstract class AbstractPlayer {
     ...
     * action from the player. The acttion returned must be contained in the
     ...
     */
    public abstract Types.ACTIONS act(StateObservation stateObs /* current game state */, ElapsedCpuTimer elapsedTimer);
